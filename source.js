...
let titleError = document.querySelector("span#title-error");
let authorInput = document.querySelector("#author");
let authorError = document.querySelector("span#author-error");
let pageInput = document.querySelector("#pageNumber");
let pageError = document.querySelector("span#page-error");
...
pageInput.addEventListener("input", (event) => {
  if (pageInput.validity.valid) {
    ...
    pageError.textContent = pageInput.validationMessage;
...
form.addEventListener("submit", (event) => {
  ...
  addBookToLibrary(
    new Book(
      ...
      form.elements["pageNumber"].value,
      form.elements["readBook"].checked
    )
  );
  form.reset();
...
function createBookContainer(book) {
  ...
  read.innerText =
    book.readBook === true
      ...
      : "You have not yet read this book";
